###########################################################################
## Makefile generated for component 'BMS_HIL_Wrapper'. 
## 
## Makefile     : BMS_HIL_Wrapper.mk
## Generated on : Tue May 26 15:08:58 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BMS_HIL_Wrapper.elf
...
COMPILER_COMMAND_FILE     = BMS_HIL_Wrapper_comp.rsp
CMD_FILE                  = BMS_HIL_Wrapper.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BMS_HIL_Wrapper.elf
...
DEFINES_STANDARD = -DMODEL=BMS_HIL_Wrapper -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMS_HIL_Wrapper.c.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/BMS_HIL_Wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMS_HIL_Wrapper_data.c.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/BMS_HIL_Wrapper_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/BMS_HIL_Wrapper_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
