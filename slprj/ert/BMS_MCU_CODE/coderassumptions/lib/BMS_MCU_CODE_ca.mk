...
## Generated on : Mon Jun 15 12:58:07 2026
...
OBJS = coder_assumptions_hwimpl.c.o coder_assumptions_flt.c.o BMS_MCU_CODE_ca.c.o
...
%.c.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.c.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/lib/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/lib/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/lib/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/lib/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMS_MCU_CODE_ca.c.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/BMS_MCU_CODE_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"
