...
## Generated on : Tue Jun 02 19:35:10 2026
## Final product: ./BMS_MCU_CODE.exe
...
DEFINES_ = -DUSE_FULL_LL_DRIVER -DSTM32F446xx -DUSE_HAL_DRIVER -DMW_TIMEBASESOURCE=TIM5 -DMW_GPIO_BIT_SHIFT=0 -DCODER_ASSUMPTIONS_ENABLED=1 -DXIL_SIGNAL_HANDLER=1 -DSIL_DISABLE_SUBNORMAL_SUPPORT=0
...
MODELREF_LIBS = C:/Users/odona/OneDrive/Yara/Thesis/BMS_Thesis/slprj/ert/BMS_MCU_CODE/sil/hostobj/BMS_MCU_CODE_rtwlib.lib

LIBS = $(START_DIR)/slprj/ert/_sharedutils/sil/hostobj/rtwshared.lib $(START_DIR)/slprj/ert/BMS_MCU_CODE/coderassumptions/pwslib/BMS_MCU_CODE_ca.lib
...
xil_interface.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
