...
## Generated on : Mon Jun 15 12:47:57 2026
...
%.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMS_MCU_CODE.obj : $(START_DIR)/slprj/ert/BMS_MCU_CODE/BMS_MCU_CODE.c
	$(CC) $(CFLAGS) -o "$@" "$<"
