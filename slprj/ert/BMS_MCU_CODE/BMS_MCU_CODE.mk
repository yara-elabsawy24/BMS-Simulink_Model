...
## Generated on : Thu Jun 04 17:02:45 2026
## Final product: ./BMS_MCU_CODE_rtwlib.lib
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BMS_MCU_CODE_rtwlib.lib
...
PRODUCT = ./BMS_MCU_CODE_rtwlib.lib
...
SRCS = $(START_DIR)/slprj/ert/BMS_MCU_CODE/BMS_MCU_CODE.c
...
%.c.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMS_MCU_CODE.c.o : $(START_DIR)/slprj/ert/BMS_MCU_CODE/BMS_MCU_CODE.c
	$(CC) $(CFLAGS) -o "$@" "$<"
