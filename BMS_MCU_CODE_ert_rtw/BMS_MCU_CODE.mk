...
## Generated on : Sun Jun 14 18:51:18 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BMS_MCU_CODE.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BMS_MCU_CODE.elf
...
%.c.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMS_MCU_CODE.c.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/BMS_MCU_CODE.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMS_MCU_CODE_data.c.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/BMS_MCU_CODE_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/BMS_MCU_CODE_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
