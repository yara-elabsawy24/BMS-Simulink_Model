...
int32_T BMS_PIL_Wrapper_6c5e8dbc_49_ds_tduy_p(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  ...
  (void)t1;
  (void)LC;
  out->mTDUY_P.mNumCol = 15ULL;
  out->mTDUY_P.mNumRow = 38ULL;
  ...
  out->mTDUY_P.mJc[15] = _cg_const_1[15];
  out->mTDUY_P.mIr[0] = 0;
  out->mTDUY_P.mIr[1] = 0;
  (void)LC;
  (void)out;
